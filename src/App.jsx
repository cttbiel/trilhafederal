      ...
      <div className="App">
        ...
        <main>
          <Routes>
            ...
            <Route path="/calendario" element={<CalendarioEmConstrucao />} />
            <Route path="/guia-estudos" element={<GuiaEstudosEmConstrucao />} />
            <Route path="/simulados" element={<SimuladosEmConstrucao />} />
            <Route path="/comunidade" element={<ComunidadeEmConstrucao />} />
            <Route
              path="/estatisticas"
