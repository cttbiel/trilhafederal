...
const TecnicosInter = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Escolas Técnicas | Trilha Federal</title>
        <meta
          name="description"
          content="Conheça as escolas técnicas federais e estaduais, cursos, vestibulares e oportunidades para formação técnica de qualidade."
        />
      </Helmet>
      <div className="tecnicos-inter-container">
        <div className="tecnicos-header">
          ...
          <p className="tecnicos-subtitle">
            Descubra as principais escolas técnicas federais e estaduais da
            região Sudeste. Clique em cada instituição para ver detalhes sobre
            cursos, processos seletivos, cotas e muito mais!
          </p>
