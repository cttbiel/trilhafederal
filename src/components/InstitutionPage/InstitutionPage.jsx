...
const InstitutionPage = ({
  ...
  // Determinar a rota de volta baseada no tipo de instituição
  const getBackRoute = () => {
    if (tipo?.toLowerCase().includes("instituto")) {
      return "/institutos";
    }
    if (
      tipo?.toLowerCase().includes("técnica") ||
      tipo?.toLowerCase().includes("tecnica") ||
      tipo?.toLowerCase().includes("colégio") ||
      tipo?.toLowerCase().includes("colegio") ||
      tipo?.toLowerCase().includes("cefet")
    ) {
      return "/tecnicos";
    }
