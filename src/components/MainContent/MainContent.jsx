...
const MainContent = () => {
  ...
  return (
    <>
      <Helmet>
        <title>
          Trilha Federal - Democratizando o acesso à educação pública
        </title>
        <meta
          name="description"
          content="Plataforma gratuita para vestibulares federais: simulados, informações de universidades, institutos e escolas técnicas. Prepare-se para o ENEM e outros exames!"
        />
      </Helmet>
          ...
          <div className="hero-container">
            <div className="hero-content">
              ...
              <p className="hero-subtitle">
                ...
                federais e escolas técnicas públicas. Informações que deveriam
                ser públicas, agora estão ao seu alcance.
              </p>
        ...
        <section id="sobre" className="about-section">
          <div className="container">
            ...
            <p className="section-subtitle">
              Nossa missão é democratizar o acesso à informação sobre
            ...
            <div className="mission-vision-values">
              <div className="mv-item">
                ...
                <p>
                  ...
                  <span>
                    vestibulares de universidades federais, institutos federais
              ...
              <div className="mv-item">
                ...
                <p>
                  ...
                  <span>
                    excelentes oportunidades de ensino público federal
                  </span>{" "}
              ...
              <div className="mv-item">
                ...
                <p>
                  ...
                  <span>compromisso com o desenvolvimento social</span> através
            ...
            <div className="history-section hide-on-mobile">
              ...
              <p>
                Fundado em 2025 por quatro jovens estudantes do CEFET-MG, o
                Trilha Federal nasceu da experiência pessoal de Gabriel Junio
                Silva de Carvalho e Kauã Sergio Ramos Faria, que descobriram
                tardiamente as oportunidades em instituições federais após
                estudarem em escolas de ensino médio com poucos recursos. Hoje,
                junto com Gabriel Expedito Campos Coelho da Silva e Caio
                Bertolato Silva, todos cursando Engenharia de Computação,
                criaram esta plataforma para evitar que outros estudantes passem
                pela mesma situação.
              </p>
            </div>
          ...
          <div className="container">
            ...
            <div className="resources-grid">
              ...
              <div className="resource-card">
                ...
                <h3>Estatísticas</h3>
                <p>
                  Análise de concorrência, notas de corte e dados históricos
              ...
              <div className="resource-card">
                ...
                <h3>Notificações</h3>
                <p>
                  Receba alertas sobre aberturas de inscrições e datas
                  importantes dos vestibulares.
                </p>
                <a
                  href="/notificacoes"
                  className="resource-link"
